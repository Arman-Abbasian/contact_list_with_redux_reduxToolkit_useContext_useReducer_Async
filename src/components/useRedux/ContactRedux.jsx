...
const ContactRedux = ({ name, mobile, id, deleteHandler }) => {
  return (
    <div className="flex justify-between items-center gap-5 border border-primary-4 rounded-sm p-2 w-full drop-shadow-xl shadow-sm shadow-primary-4">
      <Link to={`/contact/${id}`} className="flex-1 flex items-center gap-3">
        ...
        <div className="flex flex-col justify-start items-start flex-1 gap-2 overflow-hidden text-xs">
